...
export class AuthService implements OnInit{
    ...
    //         this.store.dispatch(new AuthActions.AuthenticateSucces(
    ...
    //     //this.user.next(user);
    //     this.store.dispatch(new AuthActions.AuthenticateSucces({ // we are dispatching the login action instead of using the user service (THE GOAL OF NGRX STORE)
    //         email: email, 
    //         userId: userId, 
    //         token: token, 
